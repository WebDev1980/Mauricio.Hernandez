...
function sharerbox(options) {
	...
	// Setting URLs for supported social-media sharing links
		...
		var facebookURL = `https://www.facebook.com/profile.php?id=100052832801685`;
		...
		var whatsappURL = `https://wa.me/524737407311?text=Este%20es%20mi%20número,%20me%20interesa%20contactarte
		`;
		...
		//Email
		var sendEmailURL = `mailto:mauriciohernandezbustamante@yahoo.com.mx?subject=Mauricio, me interesa contactarte`;
