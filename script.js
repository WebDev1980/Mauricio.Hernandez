...
window.onscroll = function() {
  ...
  if (prevScrollpos > currentScrollPos) {
    ...
    // oculta la barra de navegación después de 1500 milisegundos, solo si el usuario no está tocando la pantalla y el scroll hacia abajo ha durado al menos 150 milisegundos
    if (!isTouching) {
