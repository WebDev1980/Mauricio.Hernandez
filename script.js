...
window.onscroll = function() {
  ...
  if (prevScrollpos > currentScrollPos) {
    ...
    // muestra la barra de navegación después de 2 segundos, solo si el usuario no está tocando la pantalla
    if (!isTouching) {
    ...
    // oculta la barra de navegación después de 800 milisegundos, solo si el usuario no está tocando la pantalla
    if (!isTouching) {
