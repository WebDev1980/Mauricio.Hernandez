$(document).ready(function(){
    ...
    createTypedAnimation(".typing-2", ["Aspiro a la Coordinación en defensa de la 4T"], 20, 10, 6300, false);
    createTypedAnimation(".typing-3", ["en Silao de la Victoria"], 30, 15, 8000, false);
