$(document).ready(function(){
    ...
    createTypedAnimation(".typing-7b", ["'La vida pública cada vez más pública'"], 40, 20, 500, false);
    ...
    createTypedAnimation(".typing-17", ["Amor con amor se paga"], 65, 40, 1000, false);
