$(document).ready(function(){
    ...
    createTypedAnimation(".typing-0", ["Hola, soy"], 50, 30, 3500, false);
    createTypedAnimation(".typing-1", ["Mauricio Hernández"], 40, 20, 4800, false);
    createTypedAnimation(".typing-2", ["Aspiro a la Coordinación en defensa"], 20, 10, 6300, false);
    createTypedAnimation(".typing-3", ["de la 4T en Silao de la Victoria"], 30, 15, 8000, false);
    createTypedAnimation(".typing-4", ["Conóceme"], 45, 20, 10000, false);
    createTypedAnimation(".typing-5", ["Sobre mí"], 80, 50, 500, false);
    createTypedAnimation(".typing-6", ["Mauricio Hernández"], 50, 30, 900, true);  // Muestra el cursor durante la animación y lo oculta al final
    createTypedAnimation(".typing-7", ["a la Coordinación en defensa de la 4T"], 45, 20, 2300, true); 
    createTypedAnimation(".typing-7a", ["La Unidad"], 80, 50, 500, false);
    createTypedAnimation(".typing-7b", ["'Juntos seguimos haciendo historia'"], 40, 20, 500, false);
    createTypedAnimation(".typing-7c", ["'La vida pública cada vez más pública'"], 40, 20, 1000, false);
    ...
    createTypedAnimation(".typing-14", ["La 4T en Silao de la Victoria"], 50, 30, 1300, false);
    ...
    createTypedAnimation(".typing-17", ["'Amor con amor se paga'"], 65, 40, 1500, false);
