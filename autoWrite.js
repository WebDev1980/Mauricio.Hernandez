$(document).ready(function(){
    ...
    createTypedAnimation(".typing-6", ["Mauricio Hernández"], 50, 30, 700, true);  // Muestra el cursor durante la animación y lo oculta al final
    createTypedAnimation(".typing-7", ["a la Coordinación en defensa de la 4T"], 45, 20, 1900, true); 
